...
<div class="wp-block-group alignfull has-foreground-color has-tertiary-background-color has-text-color has-background"
    style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--30)">
    <!-- wp:group {"align":"wide","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
    <div class="wp-block-group alignwide">
        <!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0px","bottom":"1rem"}}}} -->
        <h2 class="has-text-align-center" style="margin-top:0px;margin-bottom:1rem">
            <?php echo esc_html__( 'Let\'s Work Together', 'extendable' ); ?>
        </h2>
        <!-- /wp:heading -->
        ...
        <div class="wp-block-buttons"><!-- wp:button -->
            <div class="wp-block-button"><a class="wp-block-button__link wp-element-button">
                    <?php echo esc_html__( 'Contact us', 'extendable' ); ?>
                </a></div>
            <!-- /wp:button -->
    ...
    <hr class="wp-block-separator alignfull has-text-color has-alpha-channel-opacity has-background is-style-wide"
        style="background-color:#0000000f;color:#0000000f" />
    <!-- /wp:separator -->
    ...
    <div class="wp-block-columns alignwide"
        ...
        <div class="wp-block-column"><!-- wp:heading {"level":3,"fontSize":"medium"} -->
            ...
            <!-- wp:navigation {"ref":85,"overlayMenu":"never","overlayTextColor":"foreground","layout":{"type":"flex","orientation":"vertical"},"style":{"spacing":{"blockGap":"0.5rem"}}} /-->
        </div>
        <!-- /wp:column -->
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center" style="padding-bottom:1rem">
        ...
        <!-- wp:column {"verticalAlignment":"center"} -->
        <div class="wp-block-column is-vertically-aligned-center">
            <!-- wp:social-links {"iconColor":"foreground","iconColorValue":"#0B0620","size":"has-small-icon-size","style":{"spacing":{"blockGap":{"top":"1.5rem","left":"1.5rem"}}},"className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"right"}} -->
