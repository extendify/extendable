...
<footer class="wp-block-group has-background-background-color has-background"
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group">
            ...
            <div class="wp-block-group">
                ...
                <p class="has-small-font-size">We are a company that specializes in providing a wide range of high-quality products and services to our customers.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
    ...
    <!-- wp:navigation {"align":"wide","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"left"},"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
   		<!-- wp:navigation-link {"label":"Solutions","url":"#","kind":"custom"} /-->
		<!-- wp:navigation-link {"label":"Awards","type":"","id":"","url":"#","kind":"custom"} /-->
		<!-- wp:navigation-link {"label":"Privacy Policy","url":"#","kind":"custom"} /-->
		<!-- wp:navigation-link {"label":"Terms \u0026 Conditions","url":"#","kind":"custom"} /-->
    <!-- /wp:navigation -->
