...
<h6 class="has-text-align-center has-small-font-size">This is a Medium Heading</h6>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":1,"style":{"spacing":{"margin":{"top":"0px","bottom":"1rem"}}}} -->
<h1 class="has-text-align-center" style="margin-top:0px;margin-bottom:1rem">This is a Large Default Heading Title</h1>
<!-- /wp:heading -->
