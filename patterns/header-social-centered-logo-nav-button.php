...
<div class="wp-block-group header--nav order-1 md:order-2 flex flex-row md:flex-col items-center no-mobile-gap"><!-- wp:site-title {"width":48,"className":"md:text-center order-2 is-style-rounded"} /-->
