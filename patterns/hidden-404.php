...
<div class="wp-block-group"
    ...
    <!-- wp:heading {"level":2} -->
    <h2>
        <?php echo esc_html__( 'Not found, error 404', 'extendable' ); ?>
    </h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph -->
    <p>
        <?php echo esc_html__( 'Oops, the page you are looking for does not exist or is no longer available. We are sorry about that. Just use the search form to find your way.', 'extendable' ); ?>
    </p>
    <!-- /wp:paragraph -->
